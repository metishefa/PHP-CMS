...
$subscriber_count = checkUserStatus('users', 'user_role', 'subscriber');
?>
...
$element_text = ['All posts', 'Active Posts', 'Draft Posts', 'Comments', 'Unapproved Comments', 'Users', 'Subescribes', 'Category'];
